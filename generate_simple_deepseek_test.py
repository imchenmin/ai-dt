#!/usr/bin/env python3
"""
Generate test for a single function using DeepSeek API
"""
...
def generate_single_test_with_deepseek():
    """Generate test for calculateCircleArea function using DeepSeek"""
    print("🔍 Generating Test for calculateCircleArea with DeepSeek")
    print("=" * 60)
    ...
    # Find the calculateCircleArea function
    print("2. Finding calculateCircleArea function...")
    ...
    for unit in compilation_units:
        if 'advanced_math.cpp' in unit['file']:
            ...
            for func in functions:
                if func['name'] == 'calculateCircleArea':
    ...
    if not target_function:
        print("❌ calculateCircleArea function not found!")
        return None
...
def main():
    """Main function"""
    try:
        result = generate_single_test_with_deepseek()
